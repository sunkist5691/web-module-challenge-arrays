...
function is31Flavors(arrFlav){

    if(arrFlav.length === 31) {
        return true;
    } else {
        return false;
    }
...
function removeFlavorByName(arrFlav, nameFlav){

    arrFlav.splice(arrFlav.indexOf(nameFlav), 1);
    return arrFlav;

}
console.log(removeFlavorByName(originalFlavors, 'Vanilla'));

// push back the 'Vanilla' flavor to make sure the total length of flavors are 31.
originalFlavors.push('Vanilla');
